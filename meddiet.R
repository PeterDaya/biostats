...
data <- matrix(c(2516, 2920, 2417, 3657, 4653, 3449, 2012, 1627, 1294), ncol= 3, byrow = T) 
#This command sets up the numerical data into columns of three.
colnames( data ) <- c( "Low Med. Diet" , "Medium Med. Diet", "High Med. Diet") 
...
test_results = chisq.test( data ) 
#This converts the chi square results into a variable, which can then be referenced for observed and expected values.
