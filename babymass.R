...
babydata <- read.csv("babymass.csv") #I wrote a file containing the data provided in the word document, it includes the standard deviations, mean weight, and standard errors of both groups.
babydata
